...
public class FinalTest{
    ...
    public static void TestThreeAddrGen() throws IOException, InterruptedException{
        ...
        String  eval = "public class test { int reserved; void mainEntry(int something) { something = 5; reserved = something; } }";
        ...
        eval = "public class test { int x; int y; int reserved; void f() {reserved = 3;} void mainEntry() { reserved = 0; }}";
        parser.codeGen(eval, fileName);
...
/*
        ...
        eval = "public class test { int x; int y; int reserved; void f() {reserved = 3;} void mainEntry() { reserved = 0; f();}}";
        parser.codeGen(eval, fileName);
